...
/datum/time_of_day/dawn
	...
	start = 6 HOURS //6:00:00 AM - Extended morning
...
/datum/time_of_day/daytime
	...
	start = 9 HOURS //9:00:00 AM - Extended daytime start

/datum/time_of_day/sunset
	name = "Sunset"
	color = "#ff8a63"
	start = 16 HOURS //4:00:00 PM - Extended daytime end

/datum/time_of_day/dusk
	name = "Dusk"
	color = list("#c26f56", "#c05271", "#b84933")
	start = 16.5 HOURS //4:30:00 PM

/datum/time_of_day/midnight
	name = "Midnight"
	color = list("#100a18", "#0c0412", "#0f0012")
	start = 17 HOURS //5:00:00 PM
