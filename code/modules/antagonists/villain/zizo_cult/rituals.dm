...
/datum/ritual/fleshcrafting/immortality/invoke(mob/living/user, turf/center)
	...
	target.adjust_stat_modifier(STATMOD_MISC, STATKEY_STR, -3)
	target.adjust_stat_modifier(STATMOD_MISC, STATKEY_SPD, -4)
	target.adjust_stat_modifier(STATMOD_MISC, STATKEY_END, -4)
