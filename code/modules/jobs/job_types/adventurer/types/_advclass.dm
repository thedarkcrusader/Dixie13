...
/datum/job/advclass/proc/check_requirements(mob/living/carbon/human/H)
...
#ifdef USES_PQ
	var/pq_prob = roll_chance + max((get_playerquality(H.client.ckey))/2, 0) // Takes the base pick rate of the rare class and adds the client's pq divided by 2 or 0, whichever is higher. Allows a maximum of 65 pick probability at 100 pq
#else
