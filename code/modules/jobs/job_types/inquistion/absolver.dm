/datum/job/absolver
	title = "Absolver"
	tutorial = "The Oratorium claims you are naught more than a 'cleric', \
	but you know the truth; you are a sacrificial lamb. \
	Your hands, unmarred through prayer and pacifism, have been gifted with the power to manipulate blood - \
	to siphon away the wounds of others, so that you may endure in their stead. \
	Let your censer's light shepherd the Inquisitor's retinue forth, lest they're led astray by wrath and temptation."
