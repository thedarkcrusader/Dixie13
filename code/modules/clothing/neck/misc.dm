...
/obj/item/clothing/neck/fencerguard
	name = "fencing guard"
	armor = ARMOR_PLATE
...
/obj/item/clothing/neck/fencerguard/attack_hand_secondary(mob/user)
	..()
	if(!picked)
...
/obj/item/clothing/neck/fencerguard/update_icon()
	cut_overlays()
	if(get_detail_tag())
...
/obj/item/clothing/neck/fencerguard/Initialize()
	. = ..()
	update_icon()
