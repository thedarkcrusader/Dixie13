...
/obj/item/clothing/head/wizhat/witch
	name = "witch hat"
	desc = "While officially, Witches heretical to Astrata and risk harrassment by the faithkeepers, quite a few mages and pestrans wear such hats anyways as a fashion statement."
	icon_state = "witchhat"
	detail_tag = "_detail"
