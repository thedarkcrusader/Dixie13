...
/obj/item/clothing/armor/gambeson/heavy/otavan
...
/obj/item/clothing/armor/gambeson/heavy/otavan/attack_hand_secondary(mob/user)
	..()
	if(!picked)
		var/choice = input(user, "Choose a color.", "Grenzelhoftian colors") as anything in colorlist
...
/obj/item/clothing/armor/gambeson/heavy/otavan/Initialize()
	. = ..()
	update_icon()

/obj/item/clothing/armor/gambeson/heavy/otavan/update_icon()
	cut_overlays()
	if(get_detail_tag())
