...
#define FACTION_NORTH		"Union"
#define FACTION_SOUTH		"Confederate"
...
// Civil War Factions
#define JDO_UNION_GENERAL 35.1
#define JDO_UNION_LIEUTENANT 35.2
#define JDO_UNION_SERGEANT 35.3
#define JDO_UNION_PRIVATE 35.4
#define JDO_UNION_DOCTOR 35.5
#define JDO_CONFEDERATE_GENERAL 35.6
#define JDO_CONFEDERATE_LIEUTENANT 35.7
#define JDO_CONFEDERATE_SERGEANT 35.8
#define JDO_CONFEDERATE_PRIVATE 35.9
#define JDO_CONFEDERATE_DOCTOR 36.0
