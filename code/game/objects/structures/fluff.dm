...
/obj/structure/fluff/psycross/crafted/shrine/dendor_volf
	...
	desc = "The life force of a Volf has consecrated this holy place.<br/> First present two blood baits to craft a red sacrifice.<br/> Then offer an egg and two feathers to craft a crimson sacrifice."
	icon_state = "shrine_dendor_volf"

/obj/structure/fluff/psycross/crafted/shrine/dendor_saiga
	name = "stinging shrine to Dendor"
	desc = "The life force of a Saiga has consecrated this holy place.<br/> First present a jacksberry, westleach leaf, and eel to craft a yellow sacrifice.<br/> Then offer a jacksberry, calendula flower, and fiber to craft a citrine sacrifice."
	icon_state = "shrine_dendor_saiga"

/obj/structure/fluff/psycross/crafted/shrine/dendor_gote
	name = "growing shrine to Dendor"
	desc = "The life force of a Gote has consecrated this holy place.<br/> First present a poppy flower, swampweed leaf, and silk grub to craft a green sacrifice.<br/> Then offer a euphoriba flower, swampweed leaf, and two thorns to craft a viridian sacrifice."
	icon_state = "shrine_dendor_gote"

/obj/structure/fluff/psycross/crafted/shrine/dendor_troll
	name = "lording shrine to Dendor"
	desc = "The life force of a Troll has consecrated this holy place.<br/> First present two troll horns to craft a purple sacrifice.<br/> Then offer a piece of strange meat and two sinews to craft an indigo sacrifice."
