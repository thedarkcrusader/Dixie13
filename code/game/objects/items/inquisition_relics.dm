...
/obj/item/inqarticles/garrote/afterattack(mob/living/target, mob/living/user, proximity_flag, click_parameters)
	...
	if(istype(user.used_intent, /datum/intent/garrote/choke))	// Get started.
		...
		/obj/item/inqarticles/garrote/razor // To Yische, the dude who made this originally, I respectfully decline your opinion simply because it would be cool as hell for assassin to have a garrote
