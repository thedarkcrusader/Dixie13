...
/obj/item/weapon/mace/rungu/iron
	...
	gripped_intents = list(/datum/intent/mace/strike, /datum/intent/mace/smash)
	name = "iron rungu"
	desc = "An iron Lakkarian mace favored by the Shackle-Breakers of Sekket. It is the bane of Zalad slavers."
...
/obj/item/weapon/mace/steel/rungu
	name = "steel rungu"
	desc = "A steel Lakkarian mace favored by the Shackle-Breakers of Sekket. It is the bane of Zalad slavers."
